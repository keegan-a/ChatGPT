...
class MainWindow(QMainWindow):
    ...
    def _build_colour_controls(self) -> QWidget:
        ...
        self._colour_mode_combo.addItems(COLOUR_MODE_NAMES)
        self._colour_mode_combo.currentTextChanged.connect(self._queue_update)
        layout.addRow("Colour Mode", self._colour_mode_combo)

        self._colour_steps_slider = self._make_slider(2, 16, 6, self._queue_update)
        layout.addRow("Colour Steps", self._colour_steps_slider)

        self._palette_mix_slider = self._make_slider(0, 100, 100, self._queue_update)
        ...
        layout.addRow("Two-Tone Override", self._two_color_toggle)
    ...
    def _gather_settings(self) -> dict:
        return {
            ...
            "colour_steps": self._colour_steps_slider.value(),
    ...
    def _apply_settings(self, settings: dict) -> None:
        ...
        set_value(self._colour_steps_slider, "colour_steps", self._colour_steps_slider.setValue)
