...
def main() -> None:
    parser = argparse.ArgumentParser(description="Launch the Nostalgia Budget Suite desktop experience.")
    parser.add_argument(
        "--port",
        type=int,
        default=None,
    ...
    print("Nostalgia Budget Suite server running!", flush=True)
    ...
    try:
        ...
        print("\nShutting down Nostalgia Budget Suite…", flush=True)
