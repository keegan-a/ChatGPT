...
from app.core.dithering import DITHER_ALGORITHMS, algorithm_spec, parameter_control
...
def test_algorithm_spec_flags_controls():
    ...
    diffusion_control = parameter_control("amplitude", diffusion_spec)
    assert diffusion_control.label == "Edge Contrast"
    ...
    rotation_control = parameter_control("rotation", screen_spec)
    assert "Angle" in rotation_control.label
